...
from ingestion.l2 import fetch_perps_l2_snapshot_1m_for_symbols
...
def test_fetch_perps_l2_snapshot_1m_for_symbols_fetches_symbols_sequentially(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    snapshots = fetch_perps_l2_snapshot_1m_for_symbols(
        exchange="deribit",
        symbols=["BTC", "ETH"],
        depth=50,
        snapshot_count=1,
...
def test_fetch_perps_l2_snapshot_1m_for_symbols_logs_and_skips_failed_symbol(
...
def test_fetch_perps_l2_snapshot_1m_for_symbols_respects_expired_runtime_budget(
